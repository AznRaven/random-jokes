  ...
  return (
    <>
      <div className="col-10 mx-auto">
        ...
        <br />
        <h1>
          Random "{category.charAt(0).toUpperCase() + category.slice(1)}" Quotes
        </h1>
        <br />
        <br />
        ...
        <div class="input-group has-validation">
          <button class="btn btn-outline-primary" onClick={fetchData}>
            Randomize {category.charAt(0).toUpperCase() + category.slice(1)}{" "}
            Quotes
          </button>
          <div></div>
          <div class="form-floating is-invalid">
            ...
            <label for="floatingInputGroup2">
              Number Of {category.charAt(0).toUpperCase() + category.slice(1)}{" "}
              Quotes (Limit 10)
            </label>
          </div>
          {limit ? (
        ...
        {loading ? (
          <h1>
            {category.charAt(0).toUpperCase() + category.slice(1)} Loading...
          </h1>
        ) : (
          <>
            <table class="table table-hover table-dark table-striped col-10">
              <thead>
                <tr>
                  <th scope="col">#</th>
